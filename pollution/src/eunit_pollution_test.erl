...
addStation_test() ->
  ...
  P4 = pollution:addStation("Random", {50.2345, 18.3445}, P3),
...
addValue_test() ->
  ...
  P8 = pollution:addValue("random", {{2020, 4, 7}, {15, 30, 19}}, "PM2,5", 10, P7),
  ?assertEqual(#{{station,{50.2345,18.3445},"Aleja Slowackiego"} =>
  ...
  #{{measurement,"PM10",{{2020,4,7},{15,30,16}}} => 59,
    ...
    {station,{51.2345,19.3445},"Kazimierza"} =>
    #{{measurement,"PM2,5",{{2020,4,7},{15,30,18}}} => 117,
      {measurement,"PM2,5",{{2020,4,7},{15,30,19}}} => 30}}, P7),
  ?assertEqual(#{{station,{50.2345,18.3445},"Aleja Slowackiego"} =>
  #{{measurement,"PM10",{{2020,4,7},{15,30,16}}} => 59,
    {measurement,"PM2,5",{{2020,4,7},{15,30,17}}} => 113},
    {station,{51.2345,19.3445},"Kazimierza"} =>
    #{{measurement,"PM2,5",{{2020,4,7},{15,30,18}}} => 117,
      {measurement,"PM2,5",{{2020,4,7},{15,30,19}}} => 30}}, P8).
...
removeValue_test() ->
  ...
  #{{measurement,"PM10",{{2020,4,7},{15,30,16}}} => 59,
    ...
    #{{measurement,"PM2,5",{{2020,4,7},{15,30,18}}} => 117,
      {measurement,"PM2,5",{{2020,4,7},{15,30,19}}} => 30}},
    pollution:removeValue("Aleja Slowackiego", {{2020,4,7},{15,30,16}}, "PM2,5", Monitor)),
  ?assertEqual(#{{station,{50.2345,18.3445},"Aleja Slowackiego"} =>
  #{{measurement,"PM10",{{2020,4,7},{15,30,16}}} => 59,
    {measurement,"PM2,5",{{2020,4,7},{15,30,17}}} => 113},
    {station,{51.2345,19.3445},"Kazimierza"} =>
    #{{measurement,"PM2,5",{{2020,4,7},{15,30,18}}} => 117,
      {measurement,"PM2,5",{{2020,4,7},{15,30,19}}} => 30}},
    pollution:removeValue("Rand", {{2020,4,7},{15,30,16}}, "PM10", Monitor)).
...
getOneValue_test() ->
  ...
  ?assertEqual(error, pollution:getOneValue("Aleja Slowackiego", {{2020, 4, 7},{15,30,17}}, "PM10", Monitor)),
  ?assertEqual(error, pollution:getOneValue("Random", {{2020, 4, 7},{15,30,17}}, "PM2,5", Monitor)).
...
getStationMean_test() ->
  ...
  ?assertEqual(error, pollution:getStationMean({50.0000,18.0000}, "PM10", Monitor)),
...
getDailyAverageDataCount_test() ->
  ...
  ?assertEqual(error, pollution:getDailyAverageDataCount("Rand", {2020, 4, 7}, Monitor)).
